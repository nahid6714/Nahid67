            ...
            <div className="space-y-6">
              ...
              <div className="py-2 border-b border-slate-200 dark:border-slate-800/80">
                ...
                <div className="flex items-center justify-between gap-2">
                  ...
                  >
                    {isCopied ? <Check className="w-4 h-4 text-blue-600 dark:text-blue-400" /> : <Copy className="w-4 h-4" />}
                  </button>
                </div>
              </div>
              ...
              {/* Social Channels Row */}
              <div>
                <span className="text-[11px] font-semibold uppercase tracking-wider text-slate-500 dark:text-slate-400 block mb-3">
                  Online Profiles
                </span>
